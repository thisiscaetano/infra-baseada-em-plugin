...
variable "master_ipv4_cidr" {
  default     = null
  description = "The IP address range of the kubernetes master in this cluster."
}
...
variable "service_account_name_obs" {
  description = "The service account name"
...
variable "kubernetes_namespace_obs" {
  type    = string
  default = "obs"
}
variable "kubernetes_secret" {
  type    = string
  default = "gcpsm-secret"
}
variable "kubernetes_secret_obs" {
  type    = string
  default = "loki-access-gcs"
}
#valor que gera o json da service account, nao trocar!!
variable "private_key_type" {
  type        = string
  default     = "TYPE_GOOGLE_CREDENTIALS_FILE"
  description = "value for private key type"
}